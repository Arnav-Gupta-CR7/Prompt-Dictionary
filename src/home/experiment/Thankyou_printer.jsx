...
const Card = () => {
  ...
  <div className="wrapper">
    ...
    <div className="printer-display">
      <span className="printer-message"> Click to generate</span>
    ...
    <button className="print-button"><LuBrain/></button>

    <div className="receipt-wrapper">
      <div className="receipt">
        <div className="receipt-header">
          PromptDictionary <br />
          Your AI Prompt Toolkit <br />
          Build • Reuse • Scale
          <div className="logo">📘</div>
        </div>

        <div className="receipt-subheader">
          Session ID #PD-001 <br />
          Thank You Note
        </div>
        ...
        <div className="receipt-message">
          Thanks for using <strong>PromptDictionary</strong>.<br />
          Happy prompting!
        </div>
      </div>
    </div>
